        ...
        <div className="flex justify-around px-[8%] h-[65vh]"> 
            <div className="w-full">
                ...
                <div className={cn(popp.variable, "font-sans relative flex flex-col justify-end h-full pl-5 pr-12 pb-7")}>
                    ...
                    <Link href="/events" className="flex rounded-md bg-yellow-500 px-5 py-3 w-[15vw] text-center text-black hover:bg-black hover:text-white"><Video className="mr-2" />Create an Event</Link>
                </div>
            </div>

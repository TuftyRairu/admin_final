  ...
  return (
    <NavigationMenu className="grid grid-cols-12 gap-x-0 text-right mr-10">
        ...
        <Sheet>
          ...
          <SheetContent side={"left"} className="grid-flow-row grid-cols-[1fr_auto] gap-0 content-start">
            ...
            <div className="grid grid-flow-column grid-cols-1 pt-6 pr-28 h-2/4">
              ...
              <Link href={"/schedule"} className={cn(fm.variable, "font-sans rounded-md grid grid-cols-2 gap-x-0 px-5 flex align-middle items-center border-0 text-black bg-amber-300")}><CalendarCheck className="h-5 w-5 mt-0 ml-2 mr-3" /> Schedule</Link>
              <Link href={"/events"} className={cn(fm.variable, "font-sans rounded-md grid grid-cols-2 gap-x-0 px-5 flex align-middle items-center border-0 hover:bg-gray-400")}><CalendarCheck className="h-5 w-5 mt-0 ml-2 mr-3" /> Events</Link>
      ...
      <NavigationMenuList className="flex justify-between">
        <h1 className={cn(pop.variable, "font-sans mt-5 text-3xl")}>Schedule</h1>
      </NavigationMenuList>
